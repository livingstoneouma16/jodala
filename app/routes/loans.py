...
from app.calculator import loan_summary, build_loan_schedule, add_months
from app.serializers import loan_public, loan_schedule_public, repayment_public, member_full_name, client_full_name
from app.utils import (generate_loan_number, log_audit, adjust_main_account_balance,
...
def send_overdue_reminders():
    ...
    """
    from app.utils import get_overdue_loan_ids
    db = get_db()
