...
from app.serializers import mpesa_transaction_public
from app.utils import log_audit
from app.mpesa import initiate_stk_push, initiate_b2c_payment, MpesaError, get_mpesa_config, normalize_phone
...
def _b2c_result_url():
    from app.mpesa import _setting
...
def callback():
    ...
    try:
        if txn['purpose'] == 'loan_repayment':
            from app.routes.repayments import _record_repayment, _RepaymentError
            try:
            ...
            from app.routes.savings import _create_transaction
...
def _handle_b2c_result(body):
    ...
    try:
        from app.routes.loans import _disburse_loan, _DisbursementError
        try:
